...
if(!empty($_GET['invoice_id']) && $_GET['invoice_id']) {
	...
	$invoiceUserValues = $invoice->getInvoiceUser($_GET['invoice_id']);
...
$output .= '<table width="100%" border="1" cellpadding="5" cellspacing="0">
	...
	Name : '.$invoiceUserValues['first_name'].' <br /> 
	Email : '.$invoiceUserValues['email'].' <br /> 
	Org Nr : 9801 2947 291 <br /> 
	Billing Address :  '.$invoiceUserValues['address'].' <br />
	</td>
